...
namespace DAL_CapaDato
{
    public class Conexion
    {
        ...
        {   // HACK: Cadena de conexión hardcodeada. Luego ponerla como parametro de configuración del proyecto u otra alternativa.
            using ( objConexion = new SqlConnection())
            {
                strCadenaDeConexion = @"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=EcommerceUpe;Data Source=MININT-Q3PVKIF";
